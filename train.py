...
tf.flags.DEFINE_string("positive_data_file", "./data/twitter_sentiment_analysis-master/twitter_sentimentpos16.train", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/twitter_sentiment_analysis-master/twitter_sentimentneg16.train", "Data source for the negative data.")
tf.flags.DEFINE_string("neutral_data_file", "./data/twitter_sentiment_analysis-master/twitter_sentimentneu16.train", "Data source for the neutral data.")
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
           ...
           # Generate batches
            ...
            #if you need caculate cv test value/predict x_test (batch by batch)
